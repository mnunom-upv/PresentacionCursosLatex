...
\item En caso de que algún estudiante sea sorprendido realizado actividades agenas a la clase, aplica la misma penalización del punto anterior. 
\end{itemize}
\end{frame}
...
A menos que la clase lo requiera, se solicitará al INICIO de la CLASE a todos los asistentes a la clase (incluyendo al profesor) guardar su teléfono en una caja, la cual será cerrada, regresando su teléfono al finalizar la SESION.
\begin{center}
