...
%\usetheme{Szeged}
\usetheme{Warsaw}
\usecolortheme[rgb={0.8,0.8,0.26}]{structure}
...
\newcommand{\claveClassroom}{yzelmlo}
\newcommand{\claveMeet}{https://meet.google.com/dyn-agff-uyj}
...
\input{HorariosClase/2023_HorarioFSI.tex}




\input{ReglasBasicas/ReglasBasicasPosgrado.tex}
