...
\item 22 tesis dirigidas a nivel maestría.
...
\end{itemize}
\item Miembro del N\'ucleo Acad\'emico B\'asico (NAB) tanto de la Maestria en Ingeniería (MI) / Doctorado en Ciencia y Tecnología Aplicada (DCYTA) de la UPV.
\end{itemize}
\end{frame}
