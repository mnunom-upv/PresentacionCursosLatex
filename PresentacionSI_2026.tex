...
%\usetheme{Szeged}
%\usetheme{Warsaw}
\usecolortheme[rgb={0.75,0.0,0.15}]{structure}
...
%	TITLE PAGE
%----------------------------------------------------------------------------------------
\newcommand{\nombreMateria}{Sistemas Inteligentes}
...
\newcommand{\claveClassroom}{n3sg6f32}
\newcommand{\claveMeet}{https://meet.google.com/ird-udok-cuc}
\newcommand{\clavegrupo}{iti-271478}
...
\input{HorariosClase/2026_HorarioSI.tex}
