...
\begin{itemize}
\item Proyecto que funcione pero no siga las indicaciones de entrega, ser\'a penalizado.
\item Proyecto que no funcione, será anulado 
\item Se recomienda LEER con cuidado la secci\'on de entregables en esta diapositiva.
\end{itemize}
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=10cm]{DiagramaFlujoVaginal/DF.pdf}
\end{column}
\end{columns}
\end{frame}
...
Si en algún momento del curso, l
\begin{frame}
\frametitle{Flujo de Evaluaci\'on}
\begin{columns}
\begin{column}{0.5\textwidth}
