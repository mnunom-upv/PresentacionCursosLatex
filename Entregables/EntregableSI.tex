...
\begin{itemize}
\item Proyecto que no este entregado de acuerdo con las especificaciones, ser\'a penalizado.
\item Proyecto que no cumpla con lo establecido será ANULADO.
\item Se recomienda LEER con cuidado la secci\'on de entregables en esta diapositiva.
\end{itemize}
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=6cm]{DiagramaFlujoVaginal/DF.pdf}
\end{column}
\end{columns}
\end{frame}
