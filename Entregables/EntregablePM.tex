...
\begin{itemize}
\item Para las aplicaciones en Asignacion Especial (En caso de que se les solicite entregar el APK y el codigo fuente), el nombre de la aplicacion debe tener el siguiente formato (TODO EN MAYUSCULAS):
