...
\item \textit{Para proyectos en equipo}: \textbf{\package.\cuatriaberpackage.\clavegrupo.pguX\_eqYY}
\begin{itemize}
\item Ajustar pguX para proyectos en equipo (proyecto grupal unidad X = 1,2,3, etc) 
\item donde YY es el numero del equipo a dos digitos (01, 02, etc)
\end{itemize}
