...
\begin{itemize}
\item \textit{Para proyectos individuales}: \textbf{\package.\cuatriaberpackage.\clavegrupo.piuX.nuno\_maganda}
...
%\item Ajustar piuX para proyectos proyecto invidividuales (proyecto individual unidad X=1,2,3, etc)
%\item Si el proyecto es individual, debe llevar los apellidos paterno y materno
\end{itemize}
\item \textit{Para asignaciones especiales}: \textbf{\package.\cuatriaberpackage.\clavegrupo.aeuX.nuno\_maganda}

\item \textit{Para proyectos en equipo}: 

\textbf{\package.\cuatriaberpackage.\clavegrupo.pguX\_eqYY}
\begin{itemize}
%\item Ajustar pguX para proyectos en equipo (proyecto grupal unidad X = 1,2,3, etc) 
\item Ajustar YY es el numero del equipo a dos digitos (01, 02, etc)
\end{itemize}
