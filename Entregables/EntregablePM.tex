...
\begin{frame}
\frametitle{Nombre de Aplicaci\'on (ASIGNACION ESPECIAL) (1)}
\begin{itemize}
\item Para las aplicaciones en Asignacion Especial (Cuando deba crear una aplicacion), el nombre de la aplicacion debe tener el siguiente formato (TODO EN MAYUSCULAS):

Z\_CLAVEGRUPO\_UX\_AE\_APAT\_AMAT\_NOMBRE
...
\item Ejemplos:
\begin{itemize}
\item Z\_ITI-271234\_U1\_AE\_NUNO\_MAGANDA\_MARCO\_AURELIO
\item Z\_ITI-284433\_U3\_AE\_LOPEZ\_MENDEZ\_AGAPITO\_ALBERTO
\end{itemize}
...
\begin{frame}
\frametitle{Nombre de Aplicaci\'on (ASIGNACION ESPECIAL) (2)}
\begin{itemize}
\item Si en una asignacion especial se hacen equipos, entonces el formato del nombre de la APP cambiaria a:

Z\_CLAVEGRUPO\_UX\_AE\_EQ$<$NUMEROEQUIPO$>$
\item Donde:
\begin{itemize}
\item $CLAVEGRUPO$ es la clave de grupo
\item $X$ en el numero de unidad en un digito
...
\item Ejemplos:
\begin{itemize}
\item Z\_ITI-271234\_U1\_AE\_EQ01
\item Z\_ITI-284433\_U3\_AE\_EQ06
\end{itemize}
...
\begin{itemize}
\item Al crear su aplicacion y poner el nombre especificado, se crea en automatico el package \textit{com.example.$<$el nombre de su aplicacion$>$}
\item Debe remover el \textit{.example} del nombre del package, esto es, debe quedar \textit{com.$<$el nombre de su aplicacion$>$}
\end{itemize}
\includegraphics[width=7cm]{Entregables/PaqueteAndroidStudio.png}
