...
\node (prot1) [process, below of=start] {Programar aplicaci\'on y/o informe en base a lo solicitado};
...
\node (pro2b) [process, left of=dec2, xshift=-5cm] {Se aplican penalizaciones \\ y se procede a evaluarse};

\node (pro2c) [process, right of=pro1, yshift=-10cm, xshift=5cm] {Se considera proyecto nulo  \\ se asigna otro proyecto de mayor complejidad};
...
\draw [arrow] (dec2) -| node[anchor=east,yshift=-0.5cm] {no} (pro2c);
