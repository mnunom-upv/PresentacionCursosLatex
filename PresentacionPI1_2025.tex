...
%	TITLE PAGE
%----------------------------------------------------------------------------------------
\newcommand{\nombreMateria}{Proyecto Integrador I}
\newcommand{\programaAcademico}{Ingeniería en Tecnologías de la Información e Innovación Digital}
\newcommand{\cuatrimestre}{Mayo -- Agosto 2025}
\newcommand{\clavegrupo}{iti-271164}
\newcommand{\abreviaturaNombreMateria}{PM}
\newcommand{\claveClassroom}{fm7qyhvv}
\newcommand{\claveMeet}{https://meet.google.com/zbs-sjzd-oqe}
...
\input{CV_Profesor/CVProfesor.tex}

\section{Horario de Clase}
%\input{HorariosClase/2024_HorarioPM.tex}
\input{HorariosClase/2025_HorarioPI1.tex}

\input{ReglasBasicas/ReglasBasicasLicenciatura.tex}

\input{ConsideracionesEspeciales/ConsideracionesEspeciales.tex}

%\input{TemasACubrir/TemasACubrir_SistemasInteligentes.tex}
%\input{TemasACubrir/TemasACubrir_PM.tex}
\input{TemasACubrir/TemasACubrir_PI1.tex}

\input{Evaluacion/Evaluacion_SistemasInteligentes.tex}

\input{Recuperacion/RecuperacionSI.tex}

\input{Entregables/EntregableSI.tex}
%\input{Entregables/EntregablePM.tex}

\input{FechasEntrega/FechasEntrega.tex}

\input{Bitacora/Bitacora.tex}

\section{Materiales Requeridos}
%\input{MaterialesNecesario/MaterialesNecesariosSI.tex}
%\input{MaterialesNecesario/MaterialesNecesariosPM.tex}
\input{MaterialesNecesario/MaterialesNecesariosPI1.tex}



\section{Plagio}
\input{Plagio/Plagio.tex}
