...
%\usetheme{Szeged}
%\usetheme{Warsaw}
\usecolortheme[rgb={0.0,0.0,0.75}]{structure}
...
\newcommand{\claveClassroom}{xv543pb}
\newcommand{\claveMeet}{https://meet.google.com/jsb-nmxy-dht}
\newcommand{\clavegrupo}{iti-000000}
...
%\input{HorariosClase/2024_HorarioSI.tex}
\input{HorariosClase/2024_HorarioPM_SEPDIC.tex}
