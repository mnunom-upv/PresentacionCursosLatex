...
\begin{itemize}
\item Ningún proyecto será revisado despues de la fecha de cierre. Aún cuando la plataforma permita la entrega tardía, si la ultima actualización (commit) esta fuera de la fecha máxima de entrega (a menos que se haya negociado una extensión con el profesor, y haha evidencia de dicha extensión), dicho proyecto es anulado. 
\end{itemize}
\end{block}
\end{frame}
